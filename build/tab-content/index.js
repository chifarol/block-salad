...
/***/ "./src/tab-content/block.json":
/*!************************************!*\
  !*** ./src/tab-content/block.json ***!
  \************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"block-salad/tab-content","title":"tab content","description":"contents of tab","category":"blocksalad","attributes":{"index":{"type":"number","default":0},"display":{"type":"string","default":"none"}},"usesContext":["block-salad/activeTab"],"editorScript":"file:./index.js","supports":{"inserter":false}}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/tab-content/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  edit: function (_ref) {
    ...
    context["block-salad/activeTab"] == attributes.index ? setAttributes({
      display: "block"
    }) : setAttributes({
      display: "none"
    });
